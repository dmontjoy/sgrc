...
function customFormat(formatString,dateObject){
	var YYYY,YY,MMMM,MMM,MM,M,DDDD,DDD,DD,D,hhh,hh,h,mm,m,ss,s,ampm,AMPM,dMod,th,months;	
        months=["January","February","March","April","May","June","July","August","September","October","November","December"];
        YYYY=dateObject.getFullYear();
	YY = (YYYY+"").slice(-2);
        M=dateObject.getMonth()+1;
	MM = (M<10)?('0'+M):M;        
	MMM = (months[M-1]).substring(0,3);
